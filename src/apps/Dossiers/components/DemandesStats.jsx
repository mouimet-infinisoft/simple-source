...
const DemandesStats = () => {
    ...
    console.log(111, bstack.store.createCRUDObject('demandes'))
            ...
            <Col xs="6" sm>
                <Card className="card-one">
                    <Card.Body className="p-3">
                        ...
                        <h1 className="card-value mb-0 ls--1 fs-32">{statusCount?.["En cours"] ?? "0"}</h1>
            ...
            <Col sm>
                <Card className="card-one">
                    <Card.Body className="p-3">
                        ...
                        <h1 className="card-value mb-0 ls--1 fs-32">{statusCount?.["Terminée"] ?? "0"}</h1>
